  ...
  <div class="menu">
    <ul>
      <el-tooltip content="Trade" placement="right">
        <router-link tag="li" to="/trade"><img src="/img/widgets/trade.svg" alt /></router-link>
      </el-tooltip>
      <el-tooltip content="Balance" placement="right">
        <router-link tag="li" to="/balance"><img src="/img/widgets/balance.svg" alt /></router-link>
      </el-tooltip>
      <el-tooltip content="Accounting" placement="right">
        <router-link tag="li" to="/deals"><img src="/img/widgets/accounting.svg" alt /></router-link>
      </el-tooltip>
...
export default class Menu extends Vue {
  ...
  showCreateOrder () {
    const component = 'CreateOrderAside'
