...
class DashboardsStore {
  ...
  @observable drawerDashboardActiveId = ""
  ...
  @action removeWidget(dashboardId, widgetId) {
    console.log('remove widget', dashboardId, widgetId)
    // TODO: right dashboards
