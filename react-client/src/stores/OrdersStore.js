...
class OrdersStore {
  ...
  // @observable createSellPrice
  // @observable createSellAmount
  // @observable createSellTotal
...
// autorun(() => {
//   store.createSellTotal = (parseFloat(store.createSellPrice) * parseFloat(store.createSellAmount)).toFixed(8)
//   store.createSellTotal = (parseFloat(store.createSellPrice) * parseFloat(store.createSellAmount)).toFixed(8)
//   store.createSellTotal = (parseFloat(store.createSellPrice) * parseFloat(store.createSellAmount)).toFixed(8)
// })
